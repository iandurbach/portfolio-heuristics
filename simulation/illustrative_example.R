...
source("simulation/fns/evaluate_z.R") # evaluates the value of any portfolio
source("simulation/fns/solve_portfolio.R") # computes the optimal portfolio
source("simulation/fns/construct_random_portfolios.R") # constructs random portfolios
source("simulation/fns/take_the_best.R") # constructs 'add-the-best' type portfolios
source("simulation/fns/dominance.R") # constructs a portfolio with the "Pareto heuristic"
source("simulation/fns/lex.R") # constructs portfolio with 'unit value with synergy' heuristic
